...
<?php if (have_posts()) : ?>
	...
	<div class="main_content" id="single-page">
					...
					<div class="row">
						...
						<div class="col-md-8 article">
							...
							<?php if(get_field('hide_content_title', $the_ID)) { ?>
								...
								<?php echo ( get_field('show_content_title', $the_ID ) ? '<h2 class="article-title">' . get_field('content_title', $the_ID ) . '<span class="edit-link">' . '<a href="' . get_edit_post_link($the_ID) . ' title="Edit this page" class="post-edit-link">Edit this page</a>' . ' | <a href="' . add_query_arg(array('post_type'=>'page'),admin_url('post-new.php')) . ' title="Add new page" class="post-add-link">Add new page</a></span></h2>' : '' ); ?>
