					...
					<div class="row">
						...
						<div class="col-md-8 article">
							<?php if(get_field('hide_content_title', $the_ID)) { ?>
								<?php echo ( get_field('show_content_title', $the_ID ) ? '<h2 class="article-title"><span class="pre-title"><a href="' . $news_page_link . '" title="' . $news_page_title . '">' . $news_page_title . '</a></span>' . get_field('content_title', $the_ID ) . '<span class="edit-link">' . '<a href="' . get_edit_post_link($the_ID) . '" title="Edit this article" class="post-edit-link">Edit this article</a>' . ' | <a href="' . add_query_arg(array('post_type'=>'story'),admin_url('post-new.php')) . '" title="Add new article" class="post-add-link">Add new article</a></span></h2>' : '' ); ?>
							<?php } else { ?>
								<h2 class="article-title"><span class="pre-title"><a href="<?php echo $news_page_link; ?>" title="<?php echo $news_page_title; ?>"><?php echo $news_page_title; ?></a></span><?php echo get_the_title(); ?><span class="edit-link"><?php edit_post_link('Edit this article', ' | ', ''); ?><?php echo ' | <a href="' . add_query_arg(array('post_type'=>'story'),admin_url('post-new.php')) . '" title="Add new article" class="post-add-link">Add new article</a>'; ?></span></h2>
							<?php } ?>
							<div class="post-data">
