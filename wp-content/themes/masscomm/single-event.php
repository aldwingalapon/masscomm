...
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyAwA1Vv2GI7WWfKIphj9RHsQ3GagCI8xu0"></script>
...
<?php if (have_posts()) : ?>
	<div class="main_content" id="single-event">
					...
					<div class="row">
						...
						<div class="col-md-8 article">
							<?php if(get_field('hide_content_title', $the_ID)) { ?>
								<?php echo ( get_field('show_content_title', $the_ID ) ? '<h2 class="article-title"><span class="pre-title"><a href="' . $news_page_link . '" title="' . $news_page_title . '">' . $news_page_title . '</a></span>' . get_field('content_title', $the_ID ) . '<span class="edit-link">' . '<a href="' . get_edit_post_link($the_ID) . '" title="Edit this event" class="post-edit-link">Edit this event</a>' . ' | <a href="' . add_query_arg(array('post_type'=>'event'),admin_url('post-new.php')) . '" title="Add new event" class="post-add-link">Add new event</a></span></h2>' : '' ); ?>
							<?php } else { ?>
