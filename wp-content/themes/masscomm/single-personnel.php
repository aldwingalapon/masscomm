					...
					<div class="row">
						<div class="col-md-8 article">
							<?php if(get_field('hide_content_title', $the_ID)) { ?>
								<?php echo ( get_field('show_content_title', $the_ID ) ? '<h2 class="article-title"><span class="faculty_department pre-title">' . personnel_type_links($the_ID) . ' (<span class="personnel_office">' . personnel_office_links($the_ID) . '</span>)</span>' . get_field('content_title', $the_ID ) . '<span class="edit-link">' . '<a href="' . get_edit_post_link($the_ID) . '" title="Edit this personnel profile" class="post-edit-link">Edit this personnel profile</a>' . ' | <a href="' . add_query_arg(array('post_type'=>'personnel'),admin_url('post-new.php')) . '" title="Add new personnel" class="post-add-link">Add new personnel</a></span></h2>' : '' ); ?>
							<?php } else { ?>
