	...
	<header id="main_header">
		<div class="top_header">
			<div class="container">
				<div class="row">
					<!--
					<div class="col-md-3 home-site">
						<a href="<?php echo get_settings('home'); ?>" title="<?php bloginfo('name'); ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/site.png" title="<?php bloginfo('name'); ?>" alt="<?php bloginfo('name'); ?>" width="329" height="53" /></a>
					</div>
					-->
					<div class="col-md-12 utility">
						...
						<form role="search" method="get" id="menu_searchform" class="search-form collapse" action="<?php echo home_url( '/' ); ?>">
							<input type="search" class="search-field" placeholder="<?php echo esc_attr_x( 'Search the UP College of Mass Communication website…', 'placeholder' ) ?>" value="<?php echo get_search_query() ?>" name="s" title="<?php echo esc_attr_x( 'Search for:', 'label' ) ?>" />
						</form>
					</div>
		...
		<div class="middle_header">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<a href="<?php echo get_settings('home'); ?>" title="<?php bloginfo('name'); ?>" class="logo"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/header_logo.png" title="<?php bloginfo('name'); ?>" alt="<?php bloginfo('name'); ?>" width="493" height="73" /></a>
					</div>
					<div class="clearfix clear"></div>
				</div>
			</div>
