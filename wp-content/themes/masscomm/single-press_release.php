...
<?php if (have_posts()) : ?>
	<div class="main_content" id="single-press_release">
					...
					<div class="row">
						...
						<div class="col-md-8 article">
							<?php if(get_field('hide_content_title', $the_ID)) { ?>
								<?php echo ( get_field('show_content_title', $the_ID ) ? '<h2 class="article-title"><span class="pre-title"><a href="' . $press_release_page_link . '" title="' . $press_release_page_title . '">' . $press_release_page_title . '</a></span>' . get_field('content_title', $the_ID ) . '<span class="edit-link">' . '<a href="' . get_edit_post_link($the_ID) . '" title="Edit this press release" class="post-edit-link">Edit this press release</a>' . ' | <a href="' . add_query_arg(array('post_type'=>'press_release'),admin_url('post-new.php')) . '" title="Add new press release" class="post-add-link">Add new press release</a></span></h2>' : '' ); ?>
							<?php } else { ?>
								<h2 class="article-title"><span class="pre-title"><a href="<?php echo $press_release_page_link; ?>" title="<?php echo $press_release_page_title; ?>"><?php echo $press_release_page_title; ?></a></span><?php echo get_the_title(); ?><span class="edit-link"><?php edit_post_link('Edit this press release', ' | ', ''); ?><?php echo ' | <a href="' . add_query_arg(array('post_type'=>'press_release'),admin_url('post-new.php')) . '" title="Add new press release" class="post-add-link">Add new press release</a>'; ?></span></h2>
							<?php } ?>
							<div class="post-data">
